...
(本当に買ってくださった優しい方、結婚しましょう。https://www.facebook.com/lily.yuri.t　にご連絡ください)
-->
    ...
    <header class="l-header">
            ...
            <nav class="l-header__gnav nav">
                <ul class="gnav-inner">
                    ...
                    <li class="gnav-item tooltip">Speaker
                        <!--			<a href="<?php echo home_url('/speaker'); ?>">Speaker</a>-->
                    </li>
                    <li class="gnav-item tooltip">
                        Partner
                        <!--			<a href="<?php echo home_url('/partner'); ?>">Partner</a>-->
                    </li>
                    <!--			<li class="l-list-item nav-item"><a href="<?php echo home_url('/member'); ?>">Member</a></li>-->
                    ...
                    <div class="l-menu">
                        ...
                        <div class="l-menu__inner" id="js-menu_inner">
                            <ul class="menu-links" id="js-menu-links">
                                ...
                                <li class="spnav-item tooltip">Speaker - Coming soon -
                                    <!--			<a href="<?php echo home_url('/speaker'); ?>">Speaker</a>-->
                                </li>
                                <li class="spnav-item tooltip">
                                    Partner - Coming soon -
                                    <!--			<a href="<?php echo home_url('/partner'); ?>">Partner</a>-->
                                </li>
