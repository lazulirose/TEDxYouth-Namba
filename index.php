        ...
        <div class="l-articles" itemscope itemtype="http://schema.org/Article">
            ...
            <a class="l-articles__inner effect" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                <article class="index-article" itemprop="image">
                    <?php if(has_post_thumbnail()){ the_post_thumbnail(); }else{ echo '<img src="http://tedxyouthnamba.com/wp-content/uploads/2017/06/cropped-_Namba_TEDx_logo_place2_k_RGB_CS2-1-1-1024x383.png" alt="tedxyouthnamba">';}?>
